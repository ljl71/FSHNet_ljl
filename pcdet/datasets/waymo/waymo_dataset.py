...
class WaymoDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path, save_path, used_classes=None, split='train', sampled_interval=10,
        ...
        print("point_offset_cnt: ", point_offset_cnt)
...
def create_waymo_gt_database(
    ...
    workers=min(16, multiprocessing.cpu_count()), use_parallel=False, crop_gt_with_tail=False, split='trainval'):
    dataset = WaymoDataset(
        dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path,
        training=False, logger=common_utils.create_logger()
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/yaya/source/OpenPCDet/tools/cfgs/dataset_configs/waymo_dataset.yaml', help='specify the config of dataset')
